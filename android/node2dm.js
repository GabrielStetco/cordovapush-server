...
//number of messages sent since last db purge
...
* Create the model
*/
var messagesCountModel = mongoose.model('DMmessagesCount', messagesCountSchema);
...
/**
* Initialize the connection to google server
*/
    ...
    this.debugServer = net.createServer(function(stream) {
        ...
        stream.on('data', function(data) {
            ...
            switch (command) {
                ...
                case "stats":
                    //TODO retrieve this from db stats
